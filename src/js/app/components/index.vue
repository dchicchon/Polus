...
<html lang="en">
  <head>
    ...
    <link
      rel="shortcut icon"
      type="image/png"
      href="./assets/polus_tab_icon.png"
    />
    <link rel="shortcut icon" type='image/png' href="./assets/polus_tab_icon.png" />
  </head>
  <body>
    <ul id="nav">
      <li id="app-info-box">
        <div id="app-info">
          <div id="app-title">
            <img class='app-icon' src="./assets/polus_icon.png"></img>
          ...
          <div id="app-items">
            ...
            <!-- <div><a id='auth' target="_blank" rel="noopener noreferrer"></a></div> -->
          </div>
        </div>
      </li>
    ...
    <main>
      ...
      <div id="clock"></div>
      <div id="view">
        <button type="button" class="view-btn">Daily</button>
        <button type="button" class="view-btn">Week</button>
        <button type="button" class="view-btn">Month</button>
      </div>
